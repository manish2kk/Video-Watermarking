function [c1,c2,c3] = frameaveraging(images)
p1=0.3;
p2=0.7;
p3=0.9;
q1=1/p1;
...
for l=1:5:NF-5 
    averageframes{((l-1)/5)+1} =(images1{l}+images1{l+1}+images1{l+2}+images1{l+3}+images1{l+4})/5;
    averageOrigframes{((l-1)/5)+1} =(images{l}+images{l+1}+images{l+2}+images{l+3}+images{l+4})/5;
end
