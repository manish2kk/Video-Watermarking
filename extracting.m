function [c1,c2,c3] = extracting(images)
p1=0.3;
p2=0.7;
p3=0.9;
q1=1/p1;
...
wavelet='haar';
WM=imread('D:/DWT_FracOrderSVD/watermarks/watermarklogo.jpg');
NF = size(images,1);
images1 = cell(NF,1);
c1=0;
c2=0;
c3=0;
for j = 1:NF
    combinedString=strcat(int2str(j),'.jpg');
    images1{j} = imread(fullfile('D:/DWT_FracOrderSVD/WaterMarkedVideoFrames/',FileName1,combinedString));
end
tic
for j = 1:1
    ...
    c2=c2+corr2(uint8(w2g),W);
    c3=c3+corr2(uint8(w2b),W);
end
toc
%u1(:,:,1)=w2r;
%u1(:,:,2)=w2g;
